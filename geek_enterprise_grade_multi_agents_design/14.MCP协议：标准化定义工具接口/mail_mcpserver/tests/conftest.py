...
# 在导入 app 前设置测试环境变量，避免 get_settings() 在模块加载时因缺少必填项失败
...
os.environ.setdefault("USER_STORE_ENCRYPTION_KEY", _test_fernet_key)
os.environ.setdefault("USER_STORE_PATH", "data/test_users.enc")
