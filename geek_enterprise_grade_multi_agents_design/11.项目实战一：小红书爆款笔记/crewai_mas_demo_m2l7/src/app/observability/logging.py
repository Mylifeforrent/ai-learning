...
def _shared_processors() -> list:
    # structlog 处理链：逐步给日志 event_dict 补充上下文字段、级别、时间和异常信息。
    # 各 processor 作用详见 doc/notes/STRUCTLOG_PROCESSORS_EXPLAINED.md。
    return [
...
def configure_logging(log_level: str = "INFO", log_dir: str = "./logs") -> None:
    ...
    # ProcessorFormatter 负责把 structlog/logging 的事件统一渲染成最终日志文本。
