...
![图片](imgs/01-2937ac251c269396a9a252133616b16e.png)
...
![图片](imgs/02-49f4df0438a8fa36733d1c7cyy4f103a.png)

同一个 sessionId 的两轮对话自动归到一条会话时间线。这里面还能看到各种统计——trace 数量、成本统计，后面如果接入计费就都可以做。展开第二轮（搜索那条）：

![图片](imgs/03-859725f8fbfe62e336e0ddc9507371e8.png)
...
![图片](imgs/04-082f1eaa71aa918919f643fff1745b23.png)

**跨用户信息查询**——试图读取其他用户的数据，权限网关拦截。

打开 Langfuse，被拦截的请求同样有完整 trace：

![图片](imgs/05-419a90a50d29d7c160b94cbbc5d2e920.png)
...
![图片](imgs/06-6c07cf90aaf77cec0748e703b1f25ef1.png)
...
![图片](imgs/07-1a46e63bbyy089e599f5a5216b0df160.png)
...
![图片](imgs/08-3277018da1030f73bf637318b4ddbe34.png)
...
![图片](imgs/09-bc246dbbea8b1a6327eafd7f6676a117.png)
...
2. Generation 在以下时机被关闭：

     1. **下一次 BEFORE_LLM**：Agent 拿到工具结果后再次调用 LLM，此时关闭上一个 generation，并从 `prompt_messages` 里找出工具结果，补全对应 tool span 的 output
     2. **AFTER_TURN**：本轮最后一次 LLM 调用，在 `after_turn_handler` 里关闭
...
![图片](imgs/10-74fc5b26d9d7b6c2eb3ed0986553827f.png)
